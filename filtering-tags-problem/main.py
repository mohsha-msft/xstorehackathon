...
def main():
    ...
    options = {
        ...
        "filter_expression": "",
        "tags": [{
            "key": cli_options["tag_key"],
            "value": cli_options["tag_value"]
        }],
    ...
    if cli_options["list_blobs"]:
        ...
        scheduler.schedule_job(filtered_blobs, options)
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("-n", "--name-start-with", help="Blobs whose name start with given value")
